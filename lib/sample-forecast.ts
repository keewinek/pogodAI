import type { DayForecast, Forecast, HourForecast } from "./types.ts";
...
/** Przykładowa prognoza do smoke testów i bootstrapu KV po deployu. */
export function buildSampleForecast(locationId: string): Forecast {
